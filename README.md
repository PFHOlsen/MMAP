...
**3.** `data.R` - R code with preprocessing of forest fire data from Oregon in `ODF_Fire_Occurrence_Data_2000-2022.csv`. Returns arrival sequences for all regions and the regions EOA, NOA, SOA respectively.  \
