...
**2.** `MAP_functions.R` - R code with helper functions to generate MAP parameters and compute conditional path-dependent distribution of data generating Markov process.\
